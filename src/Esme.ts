...
type CommitCache = { [k: string]: bus.Esme<any, any> };

export class Esme<T extends string, V extends CommitCache> {
  ...
  renameTable = <Old extends T, New extends string>(tableName: Old, newName: New): Esme<Exclude<T, Old> | New, V> => {
    return new Esme([
      ...this._actions,
      {
  ...
  renameColumn = (tableName: T, columnName: string, newColumnName: string): Esme<T, V> => {
    return new Esme([
      ...this._actions,
      {
  ...
  dropColumn = (tableName: T, columnName: string): Esme<T, V> => {
    return new Esme([
      ...this._actions,
      {
  ...
  setDefault = (tableName: T, columnName: string, value: any): Esme<T, V> => {
    return new Esme([
      ...this._actions,
      {
  ...
  dropDefault = (tableName: T, columnName: string): Esme<T, V> => {
    return new Esme([
      ...this._actions,
      {
  ...
  //  setNotNull = (table: T, column: string): Esme<T, V> => {
  //    return new Esme([
  //      ...this._actions,
  //      {
  ...
  //    ]);
  //  };
  //  dropNotNull = (table: T, column: string): Esme<T, V> => {
  //    return new Esme([
  //      ...this._actions,
  //      {
  ...
  //    ]);
  //  };
  //  setUnique = (table: T, column: string): Esme<T, V> => {
  //    return new Esme([
  //      ...this._actions,
  //      {
  ...
  //    ]);
  //  };
  //  dropUnique = (table: T, column: string): Esme<T, V> => {
  //    return new Esme([
  //      ...this._actions,
  //      {
  ...
  //    ]);
  //  };
  //  createIndex = (table: T, column: string): Esme<T, V> => {
  //    return new Esme([
  //      ...this._actions,
  //      {
  ...
  //    ]);
  //  };
  //  dropIndex = (table: T, column: string): Esme<T, V> => {
  //    return new Esme([
  //      ...this._actions,
  //      {
  ...
  commit = <CommitName extends string>(name: CommitName): Esme<T, V & { [k in CommitName]: this }> => {
    return new Esme([
      ...this._actions,
      {
  ...
  getCommit = <Name extends keyof V>(name: Name): V[Name] => {
    ...
    return new Esme(actions) as any;
  };
